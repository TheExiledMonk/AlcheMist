...
try:
    ...
    log.warning("C extension for midstate not available. Using default implementation instead.")
    try:    
...
class JobRegistry(object):   
    def __init__(self, f, cmd, no_midstate, real_target, chk_diff):
        self.f = f
